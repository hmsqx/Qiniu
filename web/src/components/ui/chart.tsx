...
function ChartContainer({
  ...
  config: ChartConfig;
  /**
   * 控制图表容器的纵横比。默认仍然是 16:9 (video)。
   * 传入 null 关闭固定比例，此时高度可通过 className (如 h-56) / 内联样式控制。
   */
  aspect?: "video" | "square" | null;
  ...
  if (aspect === "video") base += " aspect-video";
  else if (aspect === "square") base += " aspect-square";
